...
public class Perception {
       private SituatedAgent _myAgent;
        ...
        public void updatePerception(){System.out.println("Attention Appel de updatePercetion dans la classe Perception !!");
        };
	public Perception copy() {System.out.println("Attention Appel de copy dans la classe Perception !!"); 
        return  new Perception();};
        
        public void display(){System.out.println("Attention Appel de display dans la classe Perception !!");
            };
   
	public boolean equals(Perception s) {System.out.println("Attention Appel de equals dans la classe Perception !!");
        return true;};
